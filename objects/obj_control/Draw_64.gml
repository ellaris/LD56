...
if(room != rm_start)
{
	...
	if(not instance_exists(obj_enemy))
	{
		...
		button_restart.draw(view_wport/2-128-32,view_hport-64-32)
...
{
	// display stars
	draw_sprite(spr_star,0,view_wport-32-16,32);
	...
	for(var i = 0; i < array_length(level_stars); i++)
	{
		...
		for(var j = 0; j < _stars; j++)
			draw_sprite(spr_star,0,32+_xx+20+26*j,_yy+64+32+12);
	...
	button_exit.draw(32,view_hport-64-32)
}
draw_set_color(c_white);
